...
namespace OpenGLForm
{
	...
	{
	public:
		COpenGL(System::Windows::Forms::Form ^ parentForm, GLsizei iWidth, GLsizei iHeight,int x,int y,char* project_num)
		{
	...
	protected:	
		...
		bool initGL(GLvoid)										// All setup for opengl goes here
		{
			...
			String^ str1 = System::Runtime::InteropServices::Marshal::PtrToStringAnsi((IntPtr)project_num);
			table = ExecuteQuery("SELECT [线路编号] ,[列车编号],[轨道编号] FROM [方案信息] WHERE 方案编号 ='"+ str1+"' ");
			...
			str1 = System::Runtime::InteropServices::Marshal::PtrToStringAnsi((IntPtr)track_num);
		...
		{
			 total_dist = orbit_len * 4 +pi * (outer_radius + inner_radius) ;	  //轨道一圈
